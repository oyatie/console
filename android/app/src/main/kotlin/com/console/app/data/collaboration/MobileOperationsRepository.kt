...
import com.console.app.data.offline.ConsoleClock
import com.console.app.data.offline.SystemFieldClock
...
data class MobileCalendarEventRow(
    ...
    val scopeType: com.console.api.client.model.CollaborationScopeType,
    ...
    constructor(event: CalendarEventResponse) : this(
        ...
        isCancelled = event.status == com.console.api.client.model.CalendarEventStatus.CANCELLED,
...
data class MobilePollRow(
    ...
    val anonymity: com.console.api.client.model.PollAnonymity,
...
class MobileOperationsRepository(
    ...
    private val clock: ConsoleClock = SystemFieldClock,
) {
    ...
    suspend fun recordOnDutyPing(
        state: com.console.app.data.location.GpsCollectionState,
        latitude: Double,
        longitude: Double,
        accuracyM: Double?,
