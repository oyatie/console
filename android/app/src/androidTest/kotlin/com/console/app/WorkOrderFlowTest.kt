...
class WorkOrderFlowTest {
    ...
    /**
     * Session persistence must happen before [MainActivity] is created: ConsoleApp captures
    ...
    fun seededSession_bootsAuthenticated_andDrivesFieldFlow() {
        val container = (composeRule.activity.application as ConsoleApplication).container
