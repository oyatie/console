package com.console.app.data.collaboration

import android.content.Context
import androidx.room.Room
import androidx.test.core.app.ApplicationProvider
import com.console.api.client.model.ApprovalItemsPage
import com.console.api.client.model.ApprovalItem
import com.console.api.client.model.CalendarEventResponse
import com.console.api.client.model.CalendarEventStatus
import com.console.api.client.model.CollaborationScopePolicy
...
import com.console.api.client.model.MobileStepUpActionKind
import com.console.api.client.model.PasskeyStepUpAssertion
import com.console.api.client.model.PollAnonymity
import com.console.api.client.model.PollMyVote
import com.console.api.client.model.PollOptionResponse
import com.console.api.client.model.PollResponse
import com.console.api.client.model.PollStatus
import com.console.app.data.location.GpsCollectionState
...
import com.console.app.data.offline.FixedClock
...
class MobileOperationsRepositoryTest {
    ...
    private fun openFieldDatabase(context: Context, name: String): ConsoleDatabase =
        Room.databaseBuilder(context, ConsoleDatabase::class.java, name)
            .allowMainThreadQueries()
            .build()

    private inline fun <R> ConsoleDatabase.useDatabase(block: (ConsoleDatabase) -> R): R = try {
        block(this)
    } finally {
        close()
    }
