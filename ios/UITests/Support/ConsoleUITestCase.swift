...
/// Mirror of `ConsoleAccessibilityID` (the production namespace in the app target).
///
...
/// `ios/Sources/ConsoleApp/Resources/ko.lproj/Localizable.strings`; the
...
enum UITestFixture {
    static let detailWorkOrderID = "CONSOLE_UITEST_WORK_ORDER_ID_DETAIL"
    static let startWorkOrderID = "CONSOLE_UITEST_WORK_ORDER_ID_START"
    static let reportWorkOrderID = "CONSOLE_UITEST_WORK_ORDER_ID_REPORT"
    static let reportSuccessWorkOrderID = "CONSOLE_UITEST_WORK_ORDER_ID_REPORT_SUCCESS"
    static let adminApproveWorkOrderID = "CONSOLE_UITEST_WORK_ORDER_ID_ADMIN_APPROVE"
    static let adminRejectWorkOrderID = "CONSOLE_UITEST_WORK_ORDER_ID_ADMIN_REJECT"
    static let cameraWorkOrderID = "CONSOLE_UITEST_WORK_ORDER_ID_CAMERA"
    static let messengerThreadID = "CONSOLE_UITEST_MESSENGER_THREAD_ID"
    static let messengerInitialMessageID = "CONSOLE_UITEST_MESSENGER_INITIAL_MESSAGE_ID"
    ...
    func assertNoNonDynamicTypeAccessibilityIssues(
        ...
        do {
            try app.performAccessibilityAudit(for: .all.subtracting(.dynamicType)) { issue in
                ...
                print(
                    "CONSOLE_IOS_ACCESSIBILITY_AUDIT_ISSUE "
