...
final class ConsoleAccessibilityIDParityTests: XCTestCase {
}

extension ConsoleAccessibilityIDParityTests {
    func testHermeticRunnerConfigurationRequiresMintedPairAndNamedFixtures() throws {
        let environment = [
            "CONSOLE_UITEST_BASE_URL": "http://127.0.0.1:48123",
            "CONSOLE_UITEST_ACCESS_TOKEN": "real-access-token",
            "CONSOLE_UITEST_REFRESH_TOKEN": "real-refresh-token",
