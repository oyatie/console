...
public actor KeychainSessionTokenStore: SessionTokenStore {
    ...
    public init(
        ...
        namespace: String = "console.field",
...
public enum KeychainAccessGroup {
    public static func resolveShared(
        suffix: String,
        service: String = "console.field",
        probeAccount: String = "console.field.group.probe",
        ...
        reportCleanupFailure: KeychainAccessGroupProbeCleanupFailureReporter = { failure in
            NSLog(
                "Console keychain access-group probe cleanup failed: %@:%ld",
                failure.errorDomain,
                failure.errorCode
            )
        }
...
public actor UserDefaultsDeviceIDStore: DeviceIDStore {
    ...
    public init(userDefaults: UserDefaults = .standard, namespace: String = "console.field") {
