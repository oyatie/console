...
@main
struct ConsoleUITestSeederApp: App {
    var body: some Scene {
        WindowGroup {
            SeederStatusView()
        }
...
private enum SeederOperation {
    private static let actionKey = "CONSOLE_UITEST_SEED_ACTION"
    private static let nonceKey = "CONSOLE_UITEST_SEED_NONCE"
    private static let accessTokenKey = "CONSOLE_UITEST_ACCESS_TOKEN"
    private static let refreshTokenKey = "CONSOLE_UITEST_REFRESH_TOKEN"
    private static let sharedGroupSuffix = "com.console.app.shared"
