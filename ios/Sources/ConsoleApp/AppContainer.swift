...
struct ConsoleAppContainer {
    ...
    /// (`$(AppIdentifierPrefix)com.console.app.shared`) in
    /// `Config/ConsoleApp.entitlements`. The session lives in this
    ...
    static let sharedKeychainGroupSuffix = "com.console.app.shared"

    static func live() -> ConsoleAppContainer {
        ...
        let offlineQueue = OfflineQueueRepository(
            ...
            syncGateway: gateway,
            deviceIDProvider: {
                let key = "console.field.deviceID"
        ...
        return ConsoleAppContainer(
            authRepository: PasskeyAuthRepository(
                ...
                appVersion: ConsoleCoreVersion.value
            ),
