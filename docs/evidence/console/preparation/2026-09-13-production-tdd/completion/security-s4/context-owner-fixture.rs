...
pub struct ContextFixture {
    ...
    pub serving: console_platform_request_context::serving::ServingAdmissionBinding,
...
impl ContextFixture {
    pub async fn create(
        ...
        assert!(group_count > 0 && group_count <= 33);
        assert!(group_count * companies_per_group <= 257);
