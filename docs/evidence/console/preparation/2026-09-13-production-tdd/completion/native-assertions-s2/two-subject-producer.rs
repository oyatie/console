...
use crate::{native_fixture::{build_native_deployment,NativeDeployment,TestResult},
 ...
 attendance_owner_producer::produce_attendance,payroll_source_facts_producer::{produce_payroll_sources,admit_payroll_sources},
...
pub async fn build_two_supported_deployment(pool:PgPool,scenario:&str)->TestResult<NativeDeployment> {
 ...
 let second_payroll=produce_payroll_sources(&f.pool,&f.submitter,&f.reviewer,&second,&second_sources,&second_attendance.coverage).await?;
