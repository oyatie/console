...
Direction: **A — load-bearing self-hosted Loki + managed-OCI pillars, all-OTel collection, no filtering.**
Scope: operational three-pillar observability (logs first) for the live OCI/Talos cluster (`knllogistic.com`).
