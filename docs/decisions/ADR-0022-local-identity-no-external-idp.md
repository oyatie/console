...
- `console-identity-application` must expose only local org/account administration commands, read models, and audit builders unless a real future integration is approved.
