...
export const ko = {
  ...
  facilities: {
    ...
    listLoadFailed: "시설 사례 목록을 불러오지 못했습니다.",
    detailLoadFailed: "선택한 시설 사례를 불러오지 못했습니다.",
    requestFailed: "서버가 요청을 처리하지 못했습니다.",
    networkFailed: "서버와 통신할 수 없습니다.",
    obligationRequired: "활성 HVAC 의무 ID를 입력해야 합니다.",
    createFailed: "시설 사례를 접수하지 못했습니다.",
    title: "시설 운영 사례 워크벤치",
    ...
    creating: "접수 중…",
    create: "사례 접수",
    intakeHelp: "서버가 동일 요청을 멱등하게 처리하고, 새 사례의 SLA를 계산합니다.",
    listTitle: "사례 큐",
    listDescription: "서버에서 읽은 최근 100개 사례",
    loadingCases: "사례를 불러오는 중…",
    emptyCases: "현재 권한 범위에 시설 사례가 없습니다.",
    completionSla: "완료 SLA",
    assigneePrefix: "담당",
    unassigned: "담당자 미배정",
    selectCase: "목록에서 사례를 선택하세요.",
    loadingDetail: "사례 상세를 불러오는 중…",
    responseSla: "응답 SLA",
    acceptanceSla: "인수 SLA",
    assignee: "담당자",
    unassignedShort: "미배정",
    energyDelta: "에너지 변화",
    notObserved: "관측 전",
    totalCost: "누적 비용",
    triageTitle: "1. 분류 및 일정 확정",
    scheduledFor: "현장 예정 시각",
    schedule: "일정 확정",
    assignTitle: "2. 현장 담당 배정",
    assigneeId: "담당 사용자 ID",
    assign: "담당 배정",
    startTitle: "3. 안전 확인 후 작업 시작",
    startDescription: "작업을 시작할 수 있는 권한은 서버가 담당자 기준으로 재검증합니다.",
    start: "작업 시작",
    invalidCost: "비용은 0 이상의 정수 KRW여야 합니다.",
    observeTitle: "4. 에너지·비용 관측",
    preKwh: "작업 전 kWh",
    postKwh: "작업 후 kWh",
    costKrw: "비용 (KRW)",
    observe: "관측 기록",
    evidenceRequired: "안전 점검과 서비스 보고 증빙 ID가 모두 필요합니다.",
    submitTitle: "5. 실행 증빙 제출",
    safetyEvidenceId: "안전 점검 증빙 ID",
    reportEvidenceId: "서비스 보고 증빙 ID",
    photoEvidenceId: "사진 증빙 ID (선택)",
    submit: "인수 요청 제출",
    acceptanceTitle: "6. 고객 인수 결정",
    rejectionReason: "반려 사유 (반려 시 기록)",
    accept: "인수 및 종결",
    rejecting: "반려 중…",
    reject: "재작업 요청",
    closedTitle: "종결된 사례",
    closedDescription: "서버가 인수를 기록하고 종결 상태를 반환했습니다. 추가 상태 변경은 제공하지 않습니다.",
    processing: "처리 중…",
  },
  payroll: {
    title: "급여 준비",
    ...
    closeWorkspace: {
      statuses: {
        ...
        ATTENDANCE_CLOSED: "근태 마감됨",
        CALCULATING: "계산 중",
        CALCULATED: "계산 완료",
        SUBMITTED: "결재 상신됨",
        REJECTED: "반려됨",
        APPROVED: "승인됨",
        DISBURSEMENT_SCHEDULED: "이체 예약됨",
        PAID: "지급 완료",
        ISSUED: "발행됨",
        VOID: "무효",
      },
      hours: {
        unavailable: "—",
        value: (value: number) => `${value.toFixed(1)}시간`,
      },
      columns: {
        period: "지급 기간",
        status: "마감 상태",
        ...
        overtime: "연장",
        source: "원천",
        calculationStatus: "산정 상태",
      },
      calculation: { enabled: "산정 가능", blocked: "산정 차단" },
      source: { verified: "확인된 원천 행", incomplete: "검증 또는 원천 누락" },
      list: {
        eyebrow: "급여 · 마감 운영",
        title: "급여 마감 명부",
        description: "감사되는 회차와 직원별 준비 상태를 읽기 전용으로 확인합니다.",
        refresh: "새로고침",
        denied: "급여 회차 명부 열람 권한이 없습니다.",
        error: "급여 회차 명부를 불러오지 못했습니다.",
        empty: "현재 조회 가능한 급여 회차가 없습니다.",
        loadMore: "회차 더 불러오기",
        detailAria: (label: string, status: string) => `${label} ${status} 상세 열기`,
      },
      detail: {
        denied: "이 급여 회차 상세 열람 권한이 없습니다.",
        error: "급여 회차 상세를 불러오지 못했습니다.",
        eyebrow: "선택된 회차",
        title: "급여 회차 상세",
        empty: "이 회차에는 현재 조회 가능한 직원별 급여 준비 행이 없습니다.",
        loadMore: "직원 행 더 불러오기",
        readOnlyNotice: "승인·발행·명세 배포 작업은 현재 읽기 API 계약에 포함되지 않아 이 화면에서 실행하지 않습니다.",
      },
    },
    summary: {
      employees: "등록 인원",
  ...
  console: {
    people: {
      ...
      accessDeniedDescription: "인사 명부를 조회하거나 변경할 권한이 없습니다.",
      ...
      fields: {
        ...
        org_unit: "조직", position: "직책", site: "근무지", base_pay: "기본급 (KRW)",
        employmentType: "고용 형태", homeBranch: "소속 지점", search: "직원 검색",
      },
      employmentTypes: { REGULAR: "정규직", CONTRACT: "계약직", PART_TIME: "시간제", INTERN: "인턴" },
      activeBranchPlaceholder: "활성 지점 선택",
      submit: "직원 등록",
      submitting: "저장 중…",
      saved: (name: string) => `${name} 직원 정보를 저장했습니다.`,
      detail: { name: "성명", employmentType: "고용 형태", phone: "전화번호", basePay: "기본급", homeBranch: "소속 지점", unset: "-" },
      searchPlaceholder: "성명 또는 사번",
      loading: "명부를 불러오는 중…",
    ...
    consulting: {
      ...
      empty: "표시할 컨설팅 참여가 없습니다.",
      select: "왼쪽에서 참여를 선택하면 상세 이력과 추적 연결이 표시됩니다.",
      lineage: "추적 연결",
      history: "변경 이력",
      historyEmpty: "기록된 변경 이력이 없습니다.",
      ...
      none: "없음",
      status: {
        DRAFT: "초안", PROPOSED: "제안", APPROVED: "승인됨", IMPLEMENTED: "구현됨", MEASURED: "측정됨", SUSTAINED: "지속", CORRECTIVE: "시정",
      },
      event: {
        "engagement.created": "참여 생성", "engagement.transitioned": "상태 전환", "diagnostic.recorded": "진단 기록", "finding.recorded": "발견 기록", "initiative.proposed": "이니셔티브 제안", "benefit.observed": "효익 관측",
      },
    },
    benefit: {
      title: "복리후생",
      categories: { legal: "법정", extra: "선택" },
      lifecycle: {
        draft: "초안",
        pending: "승인 대기",
        finalized: "시행 예정",
      ...
      scope: {
        ...
        branch: "법인 적용",
        org: "전사 적용",
        fallback: (scopeType: string) => `${scopeType} 적용`,
      },
      defaults: {
        tierBasis: "적용 기준",
        all: "전체",
        conditionLabel: "전사 적용",
      },
      errors: {
        request: "복리후생 요청을 처리하지 못했습니다.",
        load: "복리후생 목록을 불러오지 못했습니다.",
        requiredItem: "정책명, 적용 범위, 비용 설명은 필수입니다.",
        requiredTier: "등급의 기준, 키, 설명은 필수입니다.",
        requiredCondition: "적격성 키와 설명은 필수입니다.",
        requiredConditionValue: "적격성 값은 필수입니다.",
      },
      editor: {
        createForm: "복리후생 정책 등록",
        editForm: "복리후생 정책 수정",
        createTitle: "새 복리후생 정책 등록",
        editTitle: "복리후생 정책 수정",
        category: "분류",
        name: "정책명",
        coverage: "적용 범위 설명",
        cost: "비용 설명",
        ...
        tierValue: "등급 설명",
        conditionKey: "적격성 키",
        conditionLabel: "적격성 설명",
        conditionValue: "적격성 값",
        saving: "저장 중…",
        saveEdit: "변경 저장",
        create: "정책 등록",
        cancel: "취소",
      },
      itemCount: (count: number) => `${String(count)}개 정책`,
      annualCost: (amount: string) => `연 ₩${amount}`,
      categoryTabs: "복리후생 분류",
      loading: "복리후생 정책을 불러오는 중…",
      retry: "다시 시도",
      empty: "이 분류에 등록된 복리후생 정책이 없습니다.",
      edit: "정책 수정",
      nextState: "다음 상태",
      processing: "처리 중…",
      eligibility: "적격성",
      noConditions: "등록된 조건 없음",
      tiers: "등급",
      noTiers: "등록된 등급 없음",
      basis: "근거·연결",
      noBasis: "등록된 근거 없음",
    ...
    modules: {
      ...
      finance: {
        ...
        periodLock: {
          title: "회계 기간 마감",
          description:
            "회계 기간을 잠그고 해제 이력을 감사 가능한 상태로 관리합니다.",
          status: "상태",
          domain: "회계",
          active: "진행 중인 마감",
          history: "마감 이력",
          ...
          unlock: "마감 해제",
          unlocking: "해제 처리 중",
          unlockReason: (lockId: string) => `마감 해제 사유 ${lockId}`,
          locked: "마감됨",
          unlocked: "해제됨",
          lockedAt: "마감 시각",
          unlockedAt: "해제 시각",
          ...
          failed: "회계 기간 마감 이력을 불러오지 못했습니다.",
          conflict:
            "이미 겹치는 활성 회계 기간 마감이 있습니다. 이력은 변경되지 않았습니다.",
          errors: {
            start: "시작일을 입력하세요.",
            end: "종료일을 입력하세요.",
            range: "종료일은 시작일과 같거나 이후여야 합니다.",
            reason: "마감 사유를 입력하세요.",
            unlockReason: "마감 해제 사유를 입력하세요.",
          },
        },
        validationReasons: {
          unbalanced: "차대 불일치",
    ...
    appr: {
      ...
      bulkInbox: {
        title: "일괄 결재함",
        description: "일괄 승인은 워크플로에서 허용한 각 작업에 감사 가능한 멱등 결정을 하나씩 전송합니다.",
        refresh: "새로고침",
        contextLoading: "승인 컨텍스트를 불러오는 중입니다.",
        contextUnavailable: "승인 컨텍스트를 확인할 수 없습니다.",
        selected: (count: number) => `${String(count)}개 선택됨`,
        cancelled: "취소되었습니다. 다시 시도할 때까지 진행 중이던 결과는 확인되지 않은 상태입니다.",
        loadFailed: "결재함을 불러오지 못했습니다.",
        retryLoading: "불러오기 다시 시도",
        loadingTasks: "결재 작업을 불러오는 중입니다.",
        empty: "워크플로에서 허용한 결재 작업이 없습니다.",
        tasksAria: "결재 작업",
        personalInbox: "개인 결재함",
        due: (value: string) => `마감 ${value}`,
        pagesAria: "결재함 페이지",
        previous: "이전",
        next: "다음",
        page: (number: number) => `페이지 ${String(number)}`,
        receiptAria: "최근 일괄 결재 처리 영수증",
        receiptTitle: "최근 일괄 결재 처리 영수증",
        dismissReceipt: "영수증 닫기",
        approveSelected: (count: number) => `선택 항목 승인 (${String(count)})`,
        clearSelection: "선택 해제",
        cancelRemaining: "남은 작업 취소",
        retryUnresolved: (count: number) => `미확정 작업 다시 시도 (${String(count)})`,
        receipt: {
          unconfirmed: "결정을 전송했지만 결과가 확인되지 않았습니다. 다시 시도하면 같은 멱등 키를 사용합니다.",
          cancelledUnconfirmed: "취소 후 확정된 결과가 없습니다. 다시 시도하면 같은 멱등 키를 사용합니다.",
          approved: (taskStatus: string, runStatus: string) => `승인됨 · ${taskStatus} · ${runStatus}`,
        },
      },
    },
    workflows: {
    ...
    evidence: {
      ...
      hold: {
        ...
        applyRefreshFailed: "보존잠금은 설정됐지만 최신 보관 기록을 불러오지 못했습니다. 다시 시도하세요.",
        releaseFailed: "보존잠금을 해제하지 못했습니다.",
        releaseRefreshFailed: "보존잠금은 해제됐지만 최신 보관 기록을 불러오지 못했습니다. 다시 시도하세요.",
        refreshRetry: "최신 기록 다시 불러오기",
    ...
    mywork: {
      ...
      assigned: {
        ...
        open: "열기",
        loadMore: "더 불러오기",
        urgency: { now: "즉시", today: "오늘", wait: "대기", unknown: "우선순위 확인 필요" },
        status: { pending: "처리 대기", done: "완료", unknown: "상태 확인 필요" },
        dueAt: (timestamp: string) => `마감 ${timestamp}`,
        dueUnavailable: "마감 정보 없음",
      },
      kind: {
        approval: "결재",
        dispatch: "배차",
      ...
      calendar: {
        title: "일정",
        empty: "이 작업 범위에 예정된 일정이 없습니다.",
        unavailable: "현재 권한으로는 일정을 볼 수 없습니다.",
        loadFailed: "일정을 불러오지 못했습니다.",
        focusTitle: "집중 업무 제목",
        startsAt: "시작 시각",
        endsAt: "종료 시각",
        schedule: "집중 업무 일정 등록",
        scheduleFailed: "집중 업무 일정을 등록하지 못했습니다.",
        scheduled: "집중 업무 일정을 등록했습니다.",
        invalidRange: "종료 시각은 시작 시각보다 늦어야 합니다.",
        open: "일정 맥락 열기",
        created: "등록된 일정",
        openCreated: "협업 일정에서 확인",
        range: (from: string, to: string) => `${from} ~ ${to}`,
        partial: "일부 작업 원본을 불러오지 못했습니다. 표시된 일정 원본은 별도로 확인되었습니다.",
        truncated: "표시 가능한 일정 범위의 일부만 불러왔습니다.",
      },
      error: "불러오지 못했습니다",
      retry: "다시 시도",
      loading: "불러오는 중",
  ...
  dispatch: {
    ...
    offers: {
      title: "P1 배차 수락",
      description: "전달받은 P1 긴급 배차를 확인합니다.",
      pendingDescription: "수락 대기 중인 긴급 배차를 확인하고 바로 응답합니다.",
      pendingTitle: "수락 대기 배차",
      pendingListLabel: "P1 배차 대기 목록",
      pendingEmpty: "현재 수락 대기 중인 긴급 배차가 없습니다.",
      loading: "수락 대기 배차를 불러오는 중입니다.",
      loadFailed: "수락 대기 배차를 불러오지 못했습니다.",
      refresh: "새로고침",
      lookupLabel: "배차 코드",
