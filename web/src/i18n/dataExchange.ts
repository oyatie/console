...
export const dataExchangeTargetFields: readonly TargetField[] = [
  ...
  { id: "attendance.employee_number", domain: "attendance_direct", label: "근태 사번", sensitivity: "internal", requiredPermission: "hr_import" },
  { id: "attendance.employee_name", domain: "attendance_direct", label: "근태 직원명", sensitivity: "personal", requiredPermission: "hr_import" },
  { id: "attendance.branch_name", domain: "attendance_direct", label: "근태 지점", sensitivity: "internal", requiredPermission: "hr_import" },
  { id: "attendance.work_date", domain: "attendance_direct", label: "근무일", sensitivity: "personal", requiredPermission: "hr_import" },
  { id: "attendance.check_in_at", domain: "attendance_direct", label: "출근시간", sensitivity: "personal", requiredPermission: "hr_import" },
  { id: "attendance.check_out_at", domain: "attendance_direct", label: "퇴근시간", sensitivity: "personal", requiredPermission: "hr_import" },
  { id: "attendance.minutes_worked", domain: "attendance_direct", label: "근무분", sensitivity: "personal", requiredPermission: "hr_import" },
...
export const dataExchangeHeaderHints: readonly DataExchangeHeaderHint[] = [
  ...
  { aliases: ["근무일", "출근", "출근시간", "퇴근", "퇴근시간", "근무분", "근무시간", "attendance", "clock in", "clock out"], domain: "attendance_direct", sensitivity: "personal", targetIds: ["attendance.work_date", "attendance.check_in_at", "attendance.check_out_at", "attendance.minutes_worked"] },
