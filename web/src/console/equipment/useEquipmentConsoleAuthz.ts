...
/**
 * Equipment's route adapter consumes the console's canonical parsed authz
 * projection (same shape as production's adapter). It remains module-local
 * until the shared console registry mounts this dark module, and fails closed
 * to the canonical JWT floor while loading.
 */
export function useEquipmentConsoleAuthz() {
